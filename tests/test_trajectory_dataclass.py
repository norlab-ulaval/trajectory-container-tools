...
class TestTrajectoryDataclassFromROSBagCase:
    ...
    def test_AckermannMsgsAckermannDriveStamped_init(self, mock_ROSbag_2_trj_DC):
        ...
        dc_ = AckermannMsgsAckermannDriveStamped(
                ...
                timestamps=md.timestamps,
                timestep_index=md.ts_idx,
                drive_steering_angle=md.a,
                drive_steering_angle_velocity=md.a,
                drive_speed=md.a,
    ...
    def test_SensorMsgsImu_init(self, mock_ROSbag_2_trj_DC):
        ...
        dc_ = SensorMsgsImu(
                ...
                orientation_z=md.a,
                orientation_w=md.a,
                orientation_covariance=md.c,
                angular_velocity_x=md.a,
                angular_velocity_y=md.a,
                angular_velocity_z=md.a,
                angular_velocity_covariance=md.c,
                linear_acceleration_x=md.a,
                linear_acceleration_y=md.a,
                linear_acceleration_z=md.a,
                linear_acceleration_covariance=md.c,
                )
        print(dc_)
        assert dc_._init_trj_axe == 0

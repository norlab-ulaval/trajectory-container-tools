...
from trajectory_container_tools.dataclasses.panda_dataframe_feature_dataclass import StatePose2DStamped
...
class TestExtractCsvFeature:
    ...
    def test_extract_with_time_filtering(self, basic_csv_data):
        ...
        filtered_data = basic_csv_data[
            (basic_csv_data['t'] >= start_time) & 
            (basic_csv_data['t'] <= stop_time)
        ]
    ...
    def test_unordered_timestamps_error(self, csv_data_unordered_timestamps):
        ...
        from trajectory_container_tools.temporal.timestamps import TimestampCausalOrderingError
